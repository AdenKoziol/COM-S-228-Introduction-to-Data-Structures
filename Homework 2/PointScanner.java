...
public class PointScanner  
{
	...
	public void scan()
	{
		...
		aSorter.sort();
		x = aSorter.points[points.length / 2].getX();
		scanTime += System.nanoTime() - temp;

		temp = System.nanoTime();
		aSorter.setComparator(1);
		aSorter.sort();
		y = aSorter.points[points.length / 2].getY();
		scanTime += System.nanoTime() - temp;
	...
	public String stats()
	{
		...
		if(sortingAlgorithm == Algorithm.QuickSort)
			spaces = "        ";
		return sortingAlgorithm + spaces + points.length + "  " + scanTime;
		// TODO
	}
